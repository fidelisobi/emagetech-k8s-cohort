# K8s Pre-Requisites — Zoom Links & Recordings

> All meeting links and session recordings from the pre-requisites phase (Linux, Cloud Computing, and foundational sessions) of the Kubernetes January 2026 Cohort.
